// Компьютерная графика_ЛР2_Красько_ИВТ-4_2курс
using System;
...
"Fifteenth line"};
        ...
        private void ShowText_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 15; i++)
            {
                ...
                if ((i >= 0) && (i < 9))
                {
                    Font fn = new Font("Arial", 24, FontStyle.Underline);
                    StringFormat sf =
                ...
                {
                    k = i - 9;
                    Font fn = new Font("Calibri", 24, FontStyle.Strikeout);
                    StringFormat sf =
                    (StringFormat)StringFormat.GenericTypographic.Clone();
                ...
                if (i == 14)
                {
                    Font fn = new Font("Times New Roman", 72, FontStyle.Regular);
                    StringFormat sf =
                    (StringFormat)StringFormat.GenericTypographic.Clone();
                    sf.Alignment = StringAlignment.Center;
